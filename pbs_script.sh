...
#PBS -l nodes=2:ppn=4  			# 2 nodes with 8 tasks/node => 16 tasks

#Which Queue
#PBS -q parsys			 	# This is the only accessible queue for rbs

#PBS -N heat2Dn   			# Jobname - it gives the stdout/err filenames
...
mpirun mpi_heat2Dn.x				# That was compiled on front-end
